...
# init_paths = [f'./init_matrix_phase2/WIN-16-THR-0.2/processed_dag_{i}.npy' for i in range(4, 7)]
# SAVEPATH = "./RESULTS/CausalEffect_16_0.2_PTHP_10-18/"
init_paths = [f'./init_matrix_phase2/PC_Result/dataset_{i}_graph_matrix.npy' for i in range(4, 7)]
SAVEPATH = "./RESULTS/PC_PTHP_10-18/"
# def do_SAM():
#
