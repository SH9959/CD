...
rca = [f'./datasets_phase2/dataset_{i}/rca_prior.csv' for i in range(4, 7)]
topo = [f'./datasets_phase2/dataset_{i}/topology.npy' for i in range(4, 7)]
rca.append(None)
topo.append(None)
init_paths = [f'./DAGMA/init_d{i}.npy' for i in range(1, 5)]
SAVEPATH = "./DAGMA_PTHP"
# def do_SAM():
#
